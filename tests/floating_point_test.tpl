...
{	int allow_exit = 1 ;
	...
	*/
	...
	float_scaled_test	("flac_32.flac", allow_exit, SF_FALSE, SF_FORMAT_FLAC | SF_FORMAT_PCM_32, -184.0) ;
	...
	*/
	...
	double_scaled_test	("flac_32.flac", allow_exit, SF_FALSE, SF_FORMAT_FLAC | SF_FORMAT_PCM_32, -184.0) ;
