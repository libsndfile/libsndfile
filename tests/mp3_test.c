...
static void
mp3_short_test (void)
{	const char * filename = "mp3_short.mp3" ;
	...
	print_test_name ("mp3_short_test", filename) ;
	...
	/* Test seeking. */
	print_test_name ("mp3_seek_test", filename) ;
...
static void
mp3_int_test (void)
{	const char * filename = "mp3_int.mp3" ;
	...
	print_test_name ("mp3_int_test", filename) ;
...
static void
mp3_float_test (void)
{	const char * filename = "mp3_float.mp3" ;

	SNDFILE * file ;
	SF_INFO sfinfo ;
	float seek_data [10] ;

	print_test_name ("mp3_float_test", filename) ;
...
{	const char * filename = "mp3_double.mp3" ;

	SNDFILE * file ;
	SF_INFO sfinfo ;
	double seek_data [10] ;

	print_test_name ("mp3_double_test", filename) ;
