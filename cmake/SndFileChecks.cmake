...
if (ENABLE_OGG)
	...
	if (OGG_FOUND)
		set (HAVE_OGG 1)
		set (EXTERNAL_CODEC_LIBS ${EXTERNAL_CODEC_LIBS} ${OGG_LIBRARIES})
	else ()
		set (HAVE_OGG 0)
	endif ()
endif ()

if (ENABLE_VORBIS AND HAVE_OGG)
	find_package (Vorbis)
	if (VORBIS_FOUND)
		set (HAVE_VORBIS 1)
		set (EXTERNAL_CODEC_LIBS ${EXTERNAL_CODEC_LIBS} ${VORBIS_LIBRARIES})
	else ()
		set (HAVE_VORBIS 0)
	endif ()
else ()
...
if (ENABLE_FLAC)
	...
	if (FLAC_FOUND)
		set (HAVE_FLAC 1)
		set (EXTERNAL_CODEC_LIBS ${EXTERNAL_CODEC_LIBS} ${FLAC_LIBRARIES})
	else ()
		set (HAVE_VORBIS 0)
	endif ()
endif ()

if (ENABLE_EXPERIMENTAL AND HAVE_OGG AND ENABLE_SPEEX)
	find_package (Speex)
	if (SPEEX_FOUND)
		set (HAVE_SPEEX 1)
		set (EXTERNAL_CODEC_LIBS ${EXTERNAL_CODEC_LIBS} ${SPEEX_LIBRARIES})
	else ()
		set (HAVE_SPEEX 0)
	endif ()
else ()
