...
/*
#define WAV_AXML_MIN_CHUNK_SIZE        2048
#define WAV_AXML_MAX_CHUNK_SIZE        0xffffffff
*/


 /*#define WAV_CHNA_MIN_CHUNK_SIZE        2048
...
wavlike_read_chna_chunk (SF_PRIVATE *psf, uint32_t chunksize)
{
    ...
    printf("wavlike_read_chna_chunk: called\n");
...
wavlike_write_axml_chunk (SF_PRIVATE *psf)
{
    ...
    printf("wavlike_write_axml_chunk: called\n");
...
//if ((psf->chna_16k = axml_var_alloc ()) == NULL)
    // {    psf->error = SFE_MALLOC_FAILED ;
     //return psf->error ;
     //}
{
