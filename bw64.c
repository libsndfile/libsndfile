...
{    WAVLIKE_PRIVATE    *wpriv ;
    ...
    switch (format)
    {
        case WAVE_FORMAT_EXTENSIBLE :
            ...
            /* with WAVE_FORMAT_EXTENSIBLE the psf->sf.format field is already set. We just have to set the major to BW64 */
            psf->sf.format = (psf->sf.format & ~SF_FORMAT_TYPEMASK) | SF_FORMAT_BW64 ;
...
{    sf_count_t    current, pad_size ;
    ...
    //   wavlike_write_cart_chunk (psf) ;           //not required?
